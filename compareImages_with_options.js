...
const pixelDiff = pixelmatch(img1.data, img2.data, diff.data, width, height, {
  ...
  alpha: 0.5, // Blending factor for transparency
  aaColor: [0, 255, 255], // Color for anti-aliased pixels (cyan)
  diffColor: [255, 0, 0], // Main color for differing pixels (red)
  diffColorAlt: [0, 255, 0], // Alternate color for differing pixels (green)
  diffMask: false, // Set to true for just a binary diff mask
});
